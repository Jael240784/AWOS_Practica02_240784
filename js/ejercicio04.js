...
almacenar infomación para el  programa o sistema que estemos desarrollando.
...
console.log(`La propiedad ${property1.name} (${property1.id}) descrita como: ${property1.
description} se encuentra actualmente ${property1.isSaleable? "en venta":property1.isRentable? 
"en renta":"no disponible"}, por un precio de ${property1.price} con los servicios incluidos de 
...
property1.isRentable = false;
property1.includedServices = ["Agua", "Luz", "Gas", "Internet", "Internet", "Seguridad Privada"];
...
/*Creamos una función para darle formato a la fecha y sea más facil de leer por el usuariio*/
